...
OPENAI_REVIEW_MODEL_DEFAULT = "gpt-5.2-codex"
...
def get_review_model() -> str:
    """Get model for PR reviews, using REVIEW_MODEL env var, OPENAI_REVIEW_MODEL_DEFAULT, or default model."""
    if REVIEW_MODEL:
        return REVIEW_MODEL
    if OPENAI_API_KEY:
        return OPENAI_REVIEW_MODEL_DEFAULT
