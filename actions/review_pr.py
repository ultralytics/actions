...
def generate_pr_review(repository: str, diff_text: str, pr_title: str, pr_description: str) -> dict:
    ...
    content = (
        ...
        "SUGGESTIONS:\n"
        "- Only when confident about both the problem AND the fix\n"
        "- Single-line only, exact indentation, no comments or placeholders\n"
        "- No triple backticks (```) - breaks markdown\n"
        "- No 'start_line' when providing 'suggestion'\n\n"
        "Return JSON: "
