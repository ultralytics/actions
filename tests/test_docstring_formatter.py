...
"""Test file for Python docstring formatter with various edge cases and Google-style examples."""
...
class ExampleClass:
    ...
    Examples:
        Load a YOLODetector instance with YOLOv5
        >>> detector = YOLODetector(model_path='yolov5s.pt', conf_thres=0.25, iou_thres=0.45)
        
        Read an image and print the inference results
